...
test_section_cursor(void)
{
    ...
    test_boolean(&ctx, &parse_section_cursor, "smooth-beam-movement",
                 &conf.cursor.smooth_beam_movement);
    test_uint16(&ctx, &parse_section_cursor, "smooth-beam-movement-duration",
                &conf.cursor.smooth_beam_movement_duration_ms);
